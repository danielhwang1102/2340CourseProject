...
INSTALLED_APPS = [
    ...
    'notifications',
    'messaging',
    'emails',  # ← ADD THIS LINE (User Story #14)
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='JobPlatform <noreply@jobplatform.com>')

# Site Configuration (User Story #14)
